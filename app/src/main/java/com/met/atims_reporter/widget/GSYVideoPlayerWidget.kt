 ...
 */
open class GSYVideoPlayerWidget : GSYVideoPlayer {
    //亮度dialog
...
//            mBottomProgressBar.progressDrawable = mBottomProgressDrawable
    ...
    override fun showProgressDialog(
        ...
        if (mProgressDialog == null) {
            val localView =
                LayoutInflater.from(activityContext).inflate(progressDialogLayoutId, null)
            ...
            if (localView.findViewById<View>(progressDialogCurrentDurationTextId) is TextView) {
                mDialogSeekTime =
                    localView.findViewById<View>(progressDialogCurrentDurationTextId) as TextView
            }
            if (localView.findViewById<View>(progressDialogAllDurationTextId) is TextView) {
                mDialogTotalTime =
                    localView.findViewById<View>(progressDialogAllDurationTextId) as TextView
            }
            if (localView.findViewById<View>(progressDialogImageId) is ImageView) {
                mDialogIcon =
                    localView.findViewById<View>(progressDialogImageId) as ImageView
            }
    ...
    override fun showVolumeDialog(deltaY: Float, volumePercent: Int) {
        if (mVolumeDialog == null) {
            val localView =
                LayoutInflater.from(activityContext).inflate(volumeLayoutId, null)
            ...
            val localLayoutParams =
                mVolumeDialog!!.window!!.attributes
    ...
    override fun showBrightnessDialog(percent: Float) {
        if (mBrightnessDialog == null) {
            val localView =
                LayoutInflater.from(activityContext).inflate(brightnessLayoutId, null)
            if (localView.findViewById<View>(brightnessTextId) is TextView) {
                mBrightnessDialogTv =
                    localView.findViewById<View>(brightnessTextId) as TextView
            }
            ...
            val localLayoutParams =
                mBrightnessDialog!!.window!!.attributes
        ...
        if (mBrightnessDialogTv != null) {
            mBrightnessDialogTv!!.text = "${percent + 100} %"
        }
    }
    ...
    override fun cloneParams(from: GSYBaseVideoPlayer, to: GSYBaseVideoPlayer) {
        ...
        val sf = from as GSYVideoPlayerWidget
        val st = to as GSYVideoPlayerWidget
    ...
    override fun startWindowFullscreen(
        ...
        if (gsyBaseVideoPlayer != null) {
            val gsyVideoPlayer =
                gsyBaseVideoPlayer as GSYVideoPlayerWidget
    ...
    override fun changeUiToNormal() {
        ...
        setViewShowState(
            mLockScreen,
            if (mIfCurrentIsFullscreen && mNeedLockFull) View.VISIBLE else View.GONE
        )
        updateStartImage()
    ...
    protected val progressDialogLayoutId: Int
        protected get() = R.layout.video_progress_dialog
    ...
    protected val progressDialogProgressId: Int
        protected get() = R.id.duration_progressbar
    ...
    protected val progressDialogAllDurationTextId: Int
        protected get() = R.id.tv_duration
    ...
    protected val progressDialogImageId: Int
        protected get() = R.id.duration_image_tip
    ...
    protected val volumeLayoutId: Int
        protected get() = R.layout.video_volume_dialog
    ...
    protected val volumeProgressId: Int
        protected get() = R.id.volume_progressbar
    ...
    protected val brightnessLayoutId: Int
        protected get() = R.layout.video_brightness
    ...
    protected val brightnessTextId: Int
        protected get() = R.id.app_video_brightness
     ...
     * 全屏的UI逻辑
     */
    private fun initFullUI(standardGSYVideoPlayer: GSYVideoPlayerWidget) {
        if (mBottomProgressDrawable != null) {
