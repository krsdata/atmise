...
class SideBySideSpinner @JvmOverloads constructor(
    ...
    private lateinit var binding: SideBySideHeadingSpinnerBinding
    private lateinit var widgetContainer: WidgetContainer
    private lateinit var contextForLaterUse: Context

    init {
        context?.let {
            binding = SideBySideHeadingSpinnerBinding.inflate(
